...
<html>
  ...
  <body ng-app="myUserApp1" class="ng-cloak">
          ...
          <div class="panel panel-default">
              ...
              <div class="formcontainer">
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                    ...
                    <select ng-model="ctrl.user.country" name="" class="select input-sm" ng-options="ctr.countryId as ctr.countryName for ctr in countryAccounts track by ctr.countryId" ng-change="GetValue(ctrl.user.country)">
							<option value="">--Select--</option>
						<!-- 	<option data-ng-repeat="ctr in countryAccounts" value={{ctr.countryId}} >{{ctr.countryName}}</option> -->
    						
						</select>
						
						Selected Value is:{{ctrl.user.countryId}}
 						</div>
                          </div>
                      </div>
